...
"""
haku remark:
    line 249 shows the pass command path, maybe need to be changed in new system, also read the pass command usage in qutebrowser quick mark to generate gpg key
"""
